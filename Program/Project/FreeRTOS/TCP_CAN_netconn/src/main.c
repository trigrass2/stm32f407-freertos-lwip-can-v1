...
//char comm_reg[100] = "REG {Mode WR} {Period 200}\r\n\0";
//char comm_drive[100] = "DRIVE {Type Direct} {Name Current} {Left 300} {Right 500} {Normalized 1}\r\n\0"; 
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
...
for(i=0;i<50;i++)
{
  ...
  //NetDataDecode(NULL,comm_drive);		   //²âÊÔÃüÁî½âÂëÓÃ
